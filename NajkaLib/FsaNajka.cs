                    ...
                    for (var i = 2; i < taxonomy.Length; i += 2)
                    {
                        switch (taxonomy[i])
                        {
                            ...
                            case 'g':
                                switch (taxonomy[i + 1])
                                {
                                    case 'F':
                                        ...
                                        break;
                                    case 'I':
                                        res[i/2] = "Mužský rod neživotný";
                                        break;
                                    case 'M':
                                        res[i/2] = "Mužský rod životný";
                                        break;
                                    case 'N':
                                        res[i/2] = "Střední rod";
                                        break;
                                    case 'R':
                                        res[i/2] = "Rodina (příjmení)";
                                        break;
                                    default:
                            ...
                            case 'n':
                                ...
                                {
                                    case 'P':
                                        res[i/2] = "Množné číslo";
                                        break;
                                    case 'S':
                                        res[i/2] = "Jednotné číslo";
                                        break;
                                    default:
                                        res[i/2] = CzechExplainBad(taxonomy, i);
                                        break;
                                ...
                                break;
                            case 'x':
                                res[i/2] = taxonomy[i + 1] == 'P' ? "Speciální vzor půl" : CzechExplainBad(taxonomy, i);
                                break;
                            default:
                                res[i/2] = CzechExplainBad(taxonomy, i);
                                break;
